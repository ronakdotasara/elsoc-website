module.exports = [
"[project]/.next-internal/server/app/api/admin/events/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
async function writeAudit(entry) {
    if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"]) return;
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].auditLog.create({
            data: entry
        });
    } catch (error) {
    ...
    providers: [
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$providers$2f$credentials$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])({
            ...
            async authorize (credentials, request) {
                const parsed = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validators$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["loginSchema"].safeParse(credentials);
                ...
                const limit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rate$2d$limit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["rateLimit"])(`login:${ip}`, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rate$2d$limit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["LOGIN_LIMIT"]);
                if (!limit.ok) {
                    // Deliberately indistinguishable from wrong credentials.
                    console.warn(`[auth] rate-limited login from ${ip}`);
                    return null;
                }
                if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"]) {
                    console.error("[auth] login attempted without DATABASE_URL configured");
                    return null;
                }
                const { username, password } = parsed.data;
                const admin = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].adminUser.findUnique({
                    where: {
                        username
                    }
                });
                ...
                const hash = admin?.passwordHash ?? "$2a$12$C6UzMDM.H6dfI/f/IKcEeO7ZfHFB3W3W9d7C1kD1kW07S1r6bDD6m";
                const valid = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].compare(password, hash);
                if (!admin || !valid) return null;
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$audit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["writeAudit"])({
                    action: "login",
                    entity: "session",
...
"[project]/src/lib/admin/crud.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/db.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$audit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/audit.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admin$2f$guard$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/admin/guard.ts [app-route] (ecmascript)");
;
;
;
;
...
function revalidateAll(paths) {
    for (const path of paths){
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["revalidatePath"])(path, path.includes("[") ? "layout" : "page");
    }
}
function makeCollectionHandlers(config) {
    async function GET() {
        const guard = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admin$2f$guard$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireAdmin"])();
    ...
    async function POST(req) {
        ...
        try {
            ...
            const row = await config.delegate().create({
                data: data
            });
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$audit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["writeAudit"])({
                action: "create",
...
function makeItemHandlers(config) {
    ...
    async function DELETE(_req, ctx) {
        ...
        const { id } = await ctx.params;
        try {
            const row = await config.delegate().delete({
                where: {
                    id
                }
            });
...
function makeReorderHandler(config) {
    return async function POST(req) {
        ...
        const ids = body.ids;
        try {
            const db = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireDb"])();
            ...
            for (const path of config.revalidate)(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["revalidatePath"])(path);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                ok: true
            });
        } catch (error) {
...
"[project]/src/lib/admin/entities.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const projectCrud = {
    entity: "project",
    schema: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validators$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["projectInputSchema"],
    delegate: ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireDb"])().project,
    revalidate: [
        "/",
        "/projects",
        "/projects/[slug]"
...
const eventCrud = {
    entity: "event",
    schema: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validators$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["eventInputSchema"],
    delegate: ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireDb"])().event,
    revalidate: [
        "/",
        "/events",
        "/sparkathon"
...
const teamCrud = {
    entity: "teamMember",
    schema: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validators$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["teamMemberInputSchema"],
    delegate: ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireDb"])().teamMember,
    revalidate: [
        "/",
        "/team",
        "/sparkathon"
...
const prizeTierCrud = {
    entity: "prizeTier",
    schema: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validators$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prizeTierInputSchema"],
    delegate: ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireDb"])().prizeTier,
    revalidate: [
        "/sparkathon"
    ],
    orderBy: [
...
const problemStatementCrud = {
    entity: "problemStatement",
    schema: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validators$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["problemStatementInputSchema"],
    delegate: ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireDb"])().problemStatement,
    revalidate: [
        "/sparkathon"
    ],
    orderBy: [
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admin$2f$crud$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/admin/crud.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admin$2f$entities$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/admin/entities.ts [app-route] (ecmascript)");
;
;
const { GET, POST } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admin$2f$crud$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["makeCollectionHandlers"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admin$2f$entities$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["eventCrud"]);
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__42893ac6._.js.map